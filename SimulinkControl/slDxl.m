...
%           end
          ...
          ADDR_PRO_TORQUE_ENABLE = 64;   % hDxlUnit(DXL_ID).get('unAddrTorqueEnable');
          TORQUE_ENABLE = 1;
          
          calllib( lib_name, 'write1ByteTxRx', port_num, PROTOCOL_VERSION, DXL_ID, 11, 0);                    
          ...
          elseif calllib(lib_name, 'getLastRxPacketError', port_num, PROTOCOL_VERSION) ~= myDxl.eSUCCESS
